    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl shadow-xl p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">Business Deals</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
            <p className="text-sm text-green-100 mb-1">Total Return</p>
            <p className="text-2xl font-bold">
              SAR {totalReturn.toLocaleString()}
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
            <p className="text-sm text-green-100 mb-1">Return Percentage</p>
            <p className="text-2xl font-bold">
        ...
        {investments.length === 0 ? (
          <Card>
            <CardContent className="py-20 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">No Business Deals Yet</h3>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-2xl font-bold text-gray-900">All Business Deals</CardTitle>
                  <p className="text-sm text-gray-500 mt-1">{investments.length} active deals</p>
                </div>
                {user.role === 'OWNER' && (
                  <button className="px-6 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    + Add New Deal
                  </button>
                )}
              </div>
              ...
              <Table>
                ...
                <TableBody>
                  {investments.map((inv: any) => {
                    ...
                    return (
                      <TableRow key={inv.id} className="hover:bg-green-50 transition-colors duration-150">
