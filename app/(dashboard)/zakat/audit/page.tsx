...
export default async function ZakatPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl shadow-md p-6 text-white">
        <h1 className="text-2xl font-bold">📋 Zakat Audit</h1>
        <p className="text-sm text-slate-400 mt-1">
          Review all Zakat calculations and payment history. Zakat is calculated only on cash received after the haul is completed.
        </p>
      </div>
